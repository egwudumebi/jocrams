...
class SettingsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $settings = [
            ...
            ['group_name' => 'general', 'setting_key' => 'contact_email', 'setting_value' => 'jocrams2026@gmail.com', 'is_secret' => false],
            ['group_name' => 'general', 'setting_key' => 'support_email', 'setting_value' => 'jocrams2026@gmail.com', 'is_secret' => false],
            ['group_name' => 'general', 'setting_key' => 'social_facebook', 'setting_value' => '', 'is_secret' => false],
            ['group_name' => 'general', 'setting_key' => 'social_linkedin', 'setting_value' => '', 'is_secret' => false],
            ['group_name' => 'general', 'setting_key' => 'social_x', 'setting_value' => '', 'is_secret' => false],
            ['group_name' => 'general', 'setting_key' => 'social_instagram', 'setting_value' => '', 'is_secret' => false],
            ['group_name' => 'general', 'setting_key' => 'social_youtube', 'setting_value' => '', 'is_secret' => false],
            ...
            ['group_name' => 'membership', 'setting_key' => 'fee_student_ngn', 'setting_value' => '20000', 'is_secret' => false],
            ['group_name' => 'membership', 'setting_key' => 'fee_professional_ngn', 'setting_value' => '20000', 'is_secret' => false],
            ...
            ['group_name' => 'payment', 'setting_key' => 'bank_name', 'setting_value' => 'United Bank for Africa (UBA)', 'is_secret' => false],
            ['group_name' => 'payment', 'setting_key' => 'account_name', 'setting_value' => 'Scholars in Communication and Media Advancement Initiative (SICAMA Initiative)', 'is_secret' => false],
            ['group_name' => 'payment', 'setting_key' => 'account_number', 'setting_value' => '1030789503', 'is_secret' => false],
            ['group_name' => 'payment', 'setting_key' => 'payment_gateway', 'setting_value' => 'bank_transfer', 'is_secret' => false],
