...
<template>
    <AuthPageShell title="Choose a new password" subtitle="Set a strong password for your member account.">
        <div class="card-modern p-6 sm:p-8">
            <h2 class="font-display text-2xl font-bold text-institutional-dark">Reset password</h2>
            ...
            <form class="mt-6 space-y-4" @submit.prevent="submit">
                ...
                <button type="submit" class="btn-institutional w-full" :disabled="submitting || !canSubmit">
