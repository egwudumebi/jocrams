    ...
    routes: [
        {
            ...
            children: [
                ...
                { path: 'journal/author-guidelines', name: 'journal.author-guidelines', component: () => import('../pages/public/AuthorGuidelines.vue') },
        ...
        },
        {
            ...
            children: [
                ...
                { path: 'payment-proofs', name: 'admin.payment-proofs', component: () => import('../pages/admin/PaymentProofs.vue') },
